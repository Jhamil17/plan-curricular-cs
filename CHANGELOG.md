...
|---|---|---|---|
| 1 | §3.1 → §3.2 | Declaraba 50–54 h/semana; las fichas suman 84–91 h/semana. Factor de error 1.7× | Presupuesto de horas derivado aritméticamente de las fichas; se declara 84–91 como inviable y se separa el ciclo de contenido del bloque de calendario (§3.4) |
| 2 | §4.1 | Tabla de áreas con 47 asignaturas y 229 créditos; LEN listada con 5 asignaturas teniendo 4. Créditos inflados ~16% | Tabla recalculada desde las fichas: 47 unidades, 201 créditos, con columna de horas totales y porcentaje |
| 3 | §21 → §29 | Trazabilidad con contadores (14+12+2+2 = 30) inconsistentes con listas de 40+ entradas; asignaturas contadas dos veces | Clasificación exhaustiva y disjunta que suma exactamente 39, con categoría propia para las mixtas |
| 4 | Cierre del documento | "46 asignaturas" contradiciendo §1 ("39 + 7 laboratorios") | 39 asignaturas + 7 integradores + 1 optativa = 47 unidades, consistente en todo el documento |
| 5 | §3 | Definición de crédito incompatible con INV-801 e INV-802 (una tesis computaba 3 créditos declarando 8) | Excepción declarada explícitamente; añadida unidad ECTS-equivalente para hacer legible la carga real |
| 6 | §11.1 | "≈5–6 años" para el régimen reducido, sin derivación | Duraciones calculadas con fórmula explícita desde el presupuesto de horas (§14.1) |
| 7 | §8 | Ericsson citado sin matiz en un documento prescriptivo | Añadido el meta-análisis de Macnamara et al. (2014) como contrapeso; se conserva la regla operativa y se retira la pretensión explicativa |
| 8 | §10.4 | Criterio de asignación de franjas basado en "mañana temprano, cerebro descansado" | Corregido: la estructura se conserva, las horas de reloj se anclan al cronotipo propio medido (§10.5) |
| 9 | §10.3 | Intercalado entre dominios deliberadamente **distantes** | Corregido: el intercalado rinde más entre técnicas **confundibles**; los ocho tríos rediseñados con ese criterio y con la confusión que cada uno entrena (§13.3) |

### 35.2 Secciones nuevas

| Sección | Contenido | Por qué |
|---|---|---|
| §9 | Sustrato neurobiológico: consolidación sistémica, etiquetado sináptico, error de predicción, reconsolidación, curiosidad, estrés, neurogénesis (contestada), crítica al modelo de "modos" | La 2026.1 fundaba su metodología en psicología conductual. El nivel de mecanismo cambia decisiones concretas y da la razón de ingeniería —no de bienestar— para la corrección de carga |
| §10 | Sueño, cronobiología y sustrato físico | El único componente del régimen cuyo incumplimiento no se compensa con esfuerzo |
| §11 | Carga cognitiva, atención y límites de procesamiento | Da la base para la regla de 4 elementos por tarjeta y para el bloque monoasignatura |
| §14.1–§14.2 | Seis rutas con duración calculada, incluyendo R4 orientada a admisión a posgrado | Sustituye a las dos variantes no derivadas de la 2026.1 |
| §17 | Prácticas desacreditadas | Un documento prescriptivo debe declarar también qué no hacer |
| §18 | Protocolo de reingreso tras interrupción | Toda ruta de 5+ años se interrumpe; no tener protocolo convierte una pausa en abandono |
| §22 | Plataformas de práctica y bancos de problemas, por área | La 2026.1 daba de dónde aprender, no dónde practicar con corrección externa |
| §23 | Evaluación externa, competencias y comunidad | Sin medición externa, §14.3 detecta autoengaño frente a los propios criterios pero no frente al mundo |
| §26 | Presupuesto de horas por asignatura | Permite recalcular cualquier ruta sin rehacer el análisis |
| §35 | Este registro | Trazabilidad de la revisión |

### 35.3 Ampliaciones

- **§2:** competencia C9 (gestión instrumentada del propio aprendizaje), transversal.
- **§6:** titulaciones intermedias (Certificado de Fundamentos, Bachiller, Licenciado) para que una interrupción no deje nada acreditable.
- **§7.5:** adaptación completa de los instrumentos de evaluación para el estudiante sin institución, con lo que se pierde en cada sustitución.
- **§12.1:** octavo tipo de tarjeta —error de alta confianza— derivado de §9.4.
- **§12.3:** persistencia de mazos hasta la graduación, derivada de §9.1.
- **§13.2:** reglas 3 (verificación obligatoria), 8 (cierre escrito), 9 (adyacencia de material ligero) y 10 (techo de sueño inviolable).
- **§15:** sexto punto del protocolo de Pruebas de Dominio —predicción antes de medición.
- **§16:** tablas de usos permitidos y prohibidos de modelos de lenguaje; mecanismo explicativo desde §9.4; nota sobre asignación de capacidad de modelo.
- **§20:** siete obras abiertas añadidas (Erickson, Nystrom, Yurichev, Laaksonen, Arora & Barak, Kirk & Hwu).
- **§30:** cuarta prueba de diagnóstico de entrada —calibración, no contenido.
- **§32:** reporte de verificación con cuatro puntos resueltos y seis declarados abiertos.
- **§33:** referencias reorganizadas por capa, con 22 entradas nuevas.

### 35.4 Lo que no cambió

Las **46 fichas de la Parte III se conservan íntegras**: unidades, Pruebas de Dominio, bibliografía, recursos y protocolos de estudio. No tenían defectos; el defecto estaba en cómo el resto del documento las agregaba. Se les añadió únicamente la nota de interpretación de carga al inicio de la Parte III y la referencia a §26.
...
| §15.2 | Alcance del punto 8: las 23 fichas afectadas, los tres motivos por los que las otras 16 quedan fuera, la excepción declarada de ALG-402, la regla de componentes gobernados por prerrequisitos y la forma exigida del párrafo en la ficha | La lista se **deriva** del criterio y es re-derivable por el lector. Sin declarar los motivos de exclusión, una lista de 23 sobre 39 parece arbitraria |
| §37 | Archivo de notas de revisión, con número fijo y contador propio | Soporta N migraciones sin colisionar con los registros de cambios, que siguen tomando el siguiente entero de nivel superior |
...
### 36.3 Convención de notas de revisión

Declarada en `CONTRIBUTING.md` y aplicada en esta revisión: el `README.md` conserva **solo la nota de la revisión vigente**, y la anterior migra al **archivo de notas de revisión (§37)** como siguiente subsección libre, encabezada con la ventana de calendario en que fue vigente. La nota de la 2026.2 está en **§37.1**.

**Por qué un archivo con número fijo.** El primer diseño de esta convención mandaba cada nota a la subsección `§NN.0` de su propio registro de cambios. Tenía tres defectos: `.0` no existe en la numeración de este documento —toda subsección empieza en `.1`—; con N revisiones las notas quedan repartidas en N secciones en lugar de formar un archivo consultable; y el número de la nota quedaba acoplado al del registro, de modo que la nota vigente no tenía domicilio asignado hasta que la revisión siguiente creara el suyo. §37 tiene número fijo, contador propio y domicilio conocido de antemano.

**Referencias corregidas en el mismo commit,** como obliga la convención: `FAQ.md` apuntaba a la nota "en el README" y ahora apunta a §37.1; el puntero del `README.md` apunta a §37.

### 36.4 Fichas modificadas

**23 fichas reciben el criterio de §15.8:** MAT-101, MAT-102, MAT-103, MAT-401, SIS-101, SIS-201, SIS-203, SIS-501, SIS-502, SIS-503, SIS-701, SIS-702, ALG-201, ALG-403, LEN-201, LEN-501, LEN-502, LEN-701, TEO-401, TEO-601, IAP-602, IAP-603, IAP-801. De ellas, **SIS-501 y SIS-701 reciben además el criterio-compuerta de §15.7**.

**Criterio de inclusión, para que la lista sea auditable.** Se incluye una ficha si y solo si su Prueba de Dominio entrega un programa propio cuyo costo de ejecución crece con el tamaño de la entrada. Las 16 restantes quedan fuera por tres motivos declarados en §15.2: entregable demostrativo (10), entregable de investigación (INV-801, INV-802), y artefacto ejecutable sobre entrada de tamaño fijo (MAT-302, SIS-202, SEG-702), más la excepción de ALG-402.

**LEN-502 y LEN-701 incluidas por reevaluación de eje.** El primer análisis excluyó ambas midiendo el costo del código extraído, que es un subproducto. El costo relevante es el de **elaborar y chequear la prueba** —tiempo de kernel y tamaño de términos en LEN-701, estados alcanzables y memoria del verificador en LEN-502—, que escala con el tamaño de la formalización o del modelo. Por Curry-Howard la prueba es un programa y el kernel que la chequea lo ejecuta, de modo que el criterio se aplica sin forzarlo. El tipo **V** de §29 queda así cubierto por completo.

**Y son de las más decisionales de las 23.** Un chequeo de minutos cambia cómo se estructura una formalización y qué tácticas se evitan. En *model checking* el punto donde explota el espacio de estados decide si la propiedad se verificó o si solo se agotó la búsqueda: **una propiedad "verificada" por agotamiento no está verificada**, y distinguir un caso del otro exige haber acotado el costo. Es el único lugar del plan donde la contabilidad de costo no acompaña al resultado sino que lo condiciona.

**Nota de proceso.** La inclusión de LEN-502 se derivó de aplicar a fondo el eje que justificó LEN-701. Se registra porque el orden importa: primero se incluyó LEN-701 y se dejó LEN-502 como pendiente, y revisar esa asimetría mostró que no tenía fundamento —no era una diferencia de contenido, era una inconsistencia en la aplicación del criterio. Ninguna de las dos añade carga: sus Pruebas de Dominio ya exigían ejecutar SPIN, Lean 4 o Rocq.
...
**Componentes gobernados por prerrequisitos.** Los tres componentes —cómputo, memoria, precio— se exigen solo donde el grafo de §5 ya proveyó el aparato para razonar sobre ellos. **MAT-101 acota operaciones pero no memoria:** es de Ciclo I con prerrequisito `∅`, y la jerarquía de memoria se enseña en SIS-201 y SIS-203, ambas de Ciclo II. Exigirla allí sería inversión de prerrequisitos. El componente de precio se exige solo en IAP-602, IAP-801 y SIS-702.

**Cada párrafo nombra su número decisional.** §15.2 lo convierte en requisito de forma: el párrafo de la ficha debe nombrar la cantidad concreta que cierra una decisión de diseño en esa asignatura —tamaño de bloque en SIS-201, cruce contra la DFT directa en MAT-103, saturación de hilos en ALG-403, umbral de la tabla de Q en IAP-603— y no repetir el principio general. Once fichas se reescribieron con ese criterio tras auditar la lista: la versión genérica satisfacía el criterio produciendo mediciones que no decidían nada, que es contabilidad ritual y cae bajo la presunción de §17.

**Naturaleza de la modificación.** En las 23 fichas se añadió únicamente el criterio de evaluación que faltaba, como párrafo posterior a la Prueba de Dominio. **No se creó ninguna rúbrica tabulada**, para no romper la simetría de formato con las otras 24 fichas. No se tocaron unidades semanales, bibliografía, recursos, protocolos de estudio, créditos ni carga.

### 36.5 Exclusiones acotadas
...
## 37. Archivo de notas de revisión

Notas que encabezaron el `README.md` mientras su revisión fue la vigente, archivadas al publicarse la siguiente. La convención que las gobierna está en `CONTRIBUTING.md`; el archivo crece por subsección en orden de migración y su número de sección no cambia cuando se añaden registros de cambios nuevos.

**Advertencia de lectura, aplicable a todas.** Cada nota fue escrita cuando su versión era la vigente: sus referencias a "esta versión" apuntan a la versión que encabeza la subsección, no a la actual. Ninguna se reescribe al archivarse — se archiva tal como se publicó, salvo las frases cuyo referente era la posición en el README y que quedarían falsas fuera de él.

### 37.1 Nota de la revisión 2026.2 · vigente del 25/07/2026 al 29/07/2026
