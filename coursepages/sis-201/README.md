...
**Contabilidad de costo (§15.8).** Se acota cómputo y memoria del simulador de caché y de la multiplicación optimizada, y se declara su escalamiento respecto a la dimensión de la matriz y al tamaño de la traza, contrastado contra la complejidad derivada.
